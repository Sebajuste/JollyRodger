...
export(float, 0.0, 2000.0, 0.1) var lod_0_max_distance := 10

# The maximum LOD 1 (medium quality) distance in units.
export(float, 0.0, 2000.0, 0.1) var lod_1_max_distance := 25

# The maximum LOD 2 (low quality) distance in units.
# Past this distance, all LOD variants are hidden.
export(float, 0.0, 2000.0, 0.1) var lod_2_max_distance := 100
